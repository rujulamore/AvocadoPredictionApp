...
for epoch in range(num_epochs):
    ...
    if val_loss < best_val_loss:
        ...
        model_pkl_path = f'RegressionWeights/{batch}_Best_{num_epochs}.pth'  # Use .pth extension for PyTorch model
...
plt.savefig(f'LossFunction/MobilePytorchV2_{date_time}_{batch}_{num_epochs}.png')
plt.close()
...
loss_csv_path = f'LossFunction/Losses_mobilenetv2_{date_time}_{batch}_{num_epochs}.csv'
...
pred_vs_actual_path = f'graphs/Predicted_vs_Actual_MobilenetV2{date_time}_{batch}_{num_epochs}.png'
...
test_pred_vs_actual_path = f'graphs/Test_Predicted_vs_Actual_MobilenetV2_{date_time}_{batch}_{num_epochs}.png'
...
metrics_path = f'graphs/Test_Metrics_MobileNet_{date_time}_{batch}_{num_epochs}.txt'
